...
PennController. Template( PennController.GetTable( "list-5_DFG_stimuli.csv"),
    ...
    if (row.l5_name=="void"){
        ...
        return newTrial("post-task",
                        ...
                        ...names.map( (r,i) => {
                            ...
                            test = test.and( getScale(r.l5_name+'-scale-'+r.l5_match+', life ='+r.l5_life).test.selected() );
                            return newText(r.l5_name)
                            .before(
                            newScale(r.l5_name+'-scale-'+r.l5_match+', life ='+r.l5_life, "yes", "no") //global_z.css is needed to hide the lables "yes" & "no"
                            .log()
                            .print()
                            )
