...
PennController. Template( PennController.GetTable( "list-6_DFG_stimuli.csv"),
    ...
    if (row.l6_name=="void"){
        ...
        return newTrial("post-task",
                        ...
                        ...names.map( (r,i) => {
                            ...
                            test = test.and( getScale(r.l6_name+'-scale-'+r.l6_match+', life ='+r.l6_life).test.selected() );
                            return newText(r.l6_name)
                            .before(
                            newScale(r.l6_name+'-scale-'+r.l6_match+', life ='+r.l6_life, "yes", "no") //global_z.css is needed to hide the lables "yes" & "no"
                            .log()
                            .print()
                            )
