...
PennController. Template( PennController.GetTable( "list-2_DFG_stimuli.csv"),
    ...
    if (row.l2_name=="void"){
        ...
        return newTrial("post-task",
                        ...
                        ...names.map( (r,i) => {
                            ...
                            test = test.and( getScale(r.l2_name+'-scale-'+r.l2_match+', life ='+r.l2_life).test.selected() );
                            return newText(r.l2_name)
                            .before(
                            newScale(r.l2_name+'-scale-'+r.l2_match+', life ='+r.l2_life, "yes", "no") //global_z.css is needed to hide the lables "yes" & "no"
                            .log()
                            .print()
                            )
