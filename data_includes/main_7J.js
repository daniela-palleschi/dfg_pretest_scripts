...
3. the right yes key (F or J) in place of X in: .log("yes_key", variable.yes_X)
...
PennController( "instructions1" ,
                ...
                .settings.css("font-size", "20px")
                ,
                newCanvas("introcanvas2", 900, 520)
...
PennController. Template( PennController.GetTable( "practice.csv"),
                          variable => PennController( "practice_trials",
                                                      ...
                                                      (      
                                                          ...
                                                          .print()
                                                          ,                                                           
                                                          newTimer("delay2", 200)     //no button can be pressed before 500ms
                                                          .start()
                                                          .wait()
                                                          ,
...
PennController. Template( PennController.GetTable( "list-7_DFG_stimuli.csv"),
...
//====================================================================================================================================================================================================================
// 7. Comprehension test explanation screen // 14.05.2020 PM added and changed numbering;
...
//====================================================================================================================================================================================================================
// 8. Comprehension test proper // 26.05.2020 PM added and changed numbering; should this count towards progress?
    ...
    if (row.l7_name=="void"){
        ...
        return newTrial("post-task",
                        ...
                        ...names.map( (r,i) => {
                            ...
                            test = test.and( getScale(r.l7_name+'-scale-'+r.l7_match+', life ='+r.l7_life).test.selected() );
                            return newText(r.l7_name)
                            .before(
                            newScale(r.l7_name+'-scale-'+r.l7_match+', life ='+r.l7_life, "yes", "no") //global_z.css is needed to hide the lables "yes" & "no"
                            .log()
                            .print()
                            )
                            ...
                            Template( "post_task_Master.csv", row => handleNames(row) );
                            ...
                            newText("<p>Vielen Dank f&uuml;r Ihre Teilnahme an unserem Experiment!<p><br><b>Hier ist Ihr Validierungscode: xXXXXx</b><br><p>Bitte geben Sie diesen Code auf der Clickworker-Webseite ein, um Ihre Bezahlung zu erhalten.</p>")
                            .settings.css("font-size", "20px")
                            .settings.center()
                            .print()
                            ,
