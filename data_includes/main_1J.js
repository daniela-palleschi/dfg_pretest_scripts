    ...
    if (row.l1_name=="void"){
        ...
        return newTrial("post-task",
                        ...
                        ...names.map( (r,i) => {
                            ...
                            test = test.and( getScale(r.l1_name+'-scale-'+r.l1_match+', life ='+r.l1_life).test.selected() );
                            return newText(r.l1_name)
                            .before(
                            newScale(r.l1_name+'-scale-'+r.l1_match+', life ='+r.l1_life, "yes", "no") //global_z.css is needed to hide the lables "yes" & "no"
                            .log()
                            .print()
                            )
