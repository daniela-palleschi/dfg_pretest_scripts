...
PennController. Template( PennController.GetTable( "list-4_DFG_stimuli.csv"),
    ...
    if (row.l4_name=="void"){
        ...
        return newTrial("post-task",
                        ...
                        ...names.map( (r,i) => {
                            ...
                            test = test.and( getScale(r.l4_name+'-scale-'+r.l4_match+', life ='+r.l4_life).test.selected() );
                            return newText(r.l4_name)
                            .before(
                            newScale(r.l4_name+'-scale-'+r.l4_match+', life ='+r.l4_life, "yes", "no") //global_z.css is needed to hide the lables "yes" & "no"
                            .log()
                            .print()
                            )
