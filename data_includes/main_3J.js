...
PennController. Template( PennController.GetTable( "list-3_DFG_stimuli.csv"),
    ...
    if (row.l3_name=="void"){
        ...
        return newTrial("post-task",
                        ...
                        ...names.map( (r,i) => {
                            ...
                            test = test.and( getScale(r.l3_name+'-scale-'+r.l3_match+', life ='+r.l3_life).test.selected() );
                            return newText(r.l3_name)
                            .before(
                            newScale(r.l3_name+'-scale-'+r.l3_match+', life ='+r.l3_life, "yes", "no") //global_z.css is needed to hide the lables "yes" & "no"
                            .log()
                            .print()
                            )
