...
PennController. Template( PennController.GetTable( "list-8_DFG_stimuli.csv"),
    ...
    if (row.l8_name=="void"){
        ...
        return newTrial("post-task",
                        ...
                        ...names.map( (r,i) => {
                            ...
                            test = test.and( getScale(r.l8_name+'-scale-'+r.l8_match+', life ='+r.l8_life).test.selected() );
                            return newText(r.l8_name)
                            .before(
                            newScale(r.l8_name+'-scale-'+r.l8_match+', life ='+r.l8_life, "yes", "no") //global_z.css is needed to hide the lables "yes" & "no"
                            .log()
                            .print()
                            )
